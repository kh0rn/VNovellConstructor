...
public:
	...
	FNewNode_DialogueGraphSchemaAction(const FText& InNodeCategory, const FText& InMenuDesc, const FText& InToolTip,
	...
	static GraphNodeType* SpawnGraphNodeWithDialogueNodeFromTemplate(UEdGraph* ParentGraph,
		TSubclassOf<UDlgNode> CreateNodeType, const FVector2D Location, bool bSelectNewNode = true)
	{
...
private:
	...
	UEdGraphNode* CreateNode(UDlgDialogue* Dialogue, UEdGraph* ParentGraph, UEdGraphPin* FromPin, const FVector2D Location, bool bSelectNewNode);
